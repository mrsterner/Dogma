...
public class ItemStackBeamParticle extends GenericParticle<ItemStackBeamParticleOptions> {

    private final float uo;
    private final float vo;

    public ItemStackBeamParticle(ClientLevel world, ItemStackBeamParticleOptions data, double x, double y, double z, double xd, double yd, double zd) {
